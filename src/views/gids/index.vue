        ...
        <div class="gids-table">
          ...
          <div>
            <div class="gids-in">
              <div class="gt-search">
                <input
                  @keypress.enter="searchF"
                  v-model="search_text"
                  :placeholder="
                    placeholder == true ? $t('inputFT') : $t('inputS')
                  "
                  type="text"
                />
            ...
            <div class="table">
              ...
              >
                ...
                <div class="td">
                  <img
                    :src="
                      'https://culturevolunteers.uz/api/cdn/' + el?.member_photo
                    "
                    alt=""
                  />
                  <p>
                ...
                <div class="td">
                  <span v-for="(item, idx) in el?.languages" :key="idx"
                    >{{ langs[item - 1]?.name?.[$i18n.locale] }},
                  </span>
                </div>
                <div class="td">
                ...
                <div class="td">
                  <span v-for="(item, idx) in el?.regions" :key="idx"
                    >{{ regions[item - 1]?.name?.[$i18n.locale] }},
                  </span>
                </div>
              </div>
            </div>
  ...
  data() {
    return {
      ...
      guideTypes: [
        {
          value: 'translator',
          label: 'Gidlik, tarjimonlik sohasidagi volontyorlar',
          key: 'translator',
        },
        {
          value: 'technology',
          label: 'Axborot texnologiyalari sohasidagi volontyorlar',
          key: 'technology',
        },
        {
          value: 'culture',
          label: 'Madaniyat sohasidagi volontyorlar',
          key: 'culture',
        },
      ],
    }
